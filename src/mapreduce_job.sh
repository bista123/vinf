...
hadoop jar /hadoop-2.8.2/share/hadoop/tools/lib/hadoop-streaming-2.8.2.jar -file ./final_mapper.py -mapper ./final_mapper.py -file ./final_reducer.py -reducer ./final_reducer.py -input /output/labels/part-00000 /output/ids/part-00000 /output/categories/part-00000 /output/links/part-00000 -output /output/final

# display final output
hdfs dfs -cat /output/final/part-00000

# get final output from hdfs
hdfs dfs -get /output/final/part-00000
