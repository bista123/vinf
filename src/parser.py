...
def parse_ids():
    ...
    ttl_file = codecs.open("D:/Jakub/FIIT/ING/2/VINF/vinf_project/vinf/data/page_ids_sample.ttl", encoding='utf-8')
    csv_file = open("D:/Jakub/FIIT/ING/2/VINF/vinf_project/vinf/data/page_ids.csv", "w")
...
def parse_labels():
    ...
    ttl_file = codecs.open("D:/Jakub/FIIT/ING/2/VINF/vinf_project/vinf/data/labels_sample.ttl", encoding='utf-8')
    csv_file = open("D:/Jakub/FIIT/ING/2/VINF/vinf_project/vinf/data/labels.csv", "w")
...
def parse_categories():
    ...
    ttl_file = codecs.open('D:/Jakub/FIIT/ING/2/VINF/vinf_project/vinf/data/article_categories_sample.ttl', encoding='utf-8')
    ...
    csv_file = open("D:/Jakub/FIIT/ING/2/VINF/vinf_project/vinf/data/article_categories.csv", "w")
...
def parse_links():
    ...
    ttl_file = codecs.open('D:/Jakub/FIIT/ING/2/VINF/vinf_project/vinf/data/page_links_sample.ttl', encoding='utf-8')
    ...
    csv_file = open("D:/Jakub/FIIT/ING/2/VINF/vinf_project/vinf/data/page_links.csv", "w")
...
def merge_together():
    ...
    for file, label in zip(files, labels):
        ...
        parse_file = open(f"D:/Jakub/FIIT/ING/2/VINF/vinf_project/vinf/data/{file}", "r")
    ...
    output_file = open("D:/Jakub/FIIT/ING/2/VINF/vinf_project/vinf/data/dictionaries.csv", "w")
